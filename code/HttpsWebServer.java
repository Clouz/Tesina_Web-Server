...
public class HttpsWebServer {
	...
	// Porta su cui si metter� in ascolto il webServer
	private int port;
	// Nome del Web Server
	...
	// Home pi� quanto richiesto dal client
	private File trovaFile() {
		...
		Path joint; // Percorso dato dall'unione di root pi� quanto richiesto
					// dal client
		...
		else if (joint.toFile().isDirectory()) { // Se � una directory aggiungo
													// il "defaultFileName"

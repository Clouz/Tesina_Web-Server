...
public class HttpWebServer {
	...
	public HttpWebServer(int port, String home) {
		// Inizializzo le variabili
		this.serverName = "Piccolo HttpWebServer 1.0 by Claudio Mola";
		this.port = port;
		this.home = home;
	...
	public void creaServer() throws IOException {
		try {
			...
			System.out.println("Server: Assicurarsi che un altra istanza del" 
					+ " programma non sia già in eseguzione");
	...
	// Recupero la richiesta HTTP del client
	private Boolean clientHeader(Socket client, Scanner input) throws Exception {
	...
	private void inviaFile(Socket client) throws IOException {
		try {
			// Provo a recuperare un percorso valido dalla conbinazione della
	...
	public static void main(String[] args) {
		...
		HttpWebServer server = new HttpWebServer(80, "C:/_File/");
